            ...
            for i in range(len(tracker.tracks)):
                ...
                if (len(tracker.tracks[i].trace) > 1):
                    for j in range(len(tracker.tracks[i].trace) - 1):
                        ...
                        cv2.arrowedLine(result, (int(some_position), int(some_position_y)), (int(x2), int(y2)),
                                        track_colors[clr % 3], line_type=cv2.LINE_AA, thickness=1)
                    ...
                    if direction == "East":
                        ...
                        cv2.putText(result, 'WRONG DIRECTION', (int(x1) - 25, int(y1) - 25), cv2.FONT_HERSHEY_SIMPLEX,
                                    0.30, (0, 0, 255), 1)
                        now = dt.datetime.now()
                        ...
                        cv2.putText(result, direction, (int(x1) - 25, int(y1) - 25), cv2.FONT_HERSHEY_SIMPLEX, 0.30,
                                    (0, 255, 0), 1)
